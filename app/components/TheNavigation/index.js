...
export default function TheNavigation() {
  return (
    <nav className={[styles.nav, roboto.className].join(' ')}>
      ...
      <NavItem link="https://t.me/denis_notes">
        <svg
          className="svg-icon"
        ...
        <span className={styles.adaptiveText}>Канал в Telegram</span>
      </NavItem>

      <NavItem link="https://www.buymeacoffee.com/denisfl">
        <Image src={bmcButton} alt="Telegram icon" height={26} />
      </NavItem>
    </nav>
  )
}
